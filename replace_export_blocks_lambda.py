...
c = re.sub(facturas_pattern, lambda m: facturas_replacement, c, flags=re.DOTALL)
...
citas_replacement = '''out.println("ID;Fecha;Hora;Especialidad;Paciente C\u01f8dula;Estado");
...
c = re.sub(citas_pattern, lambda m: citas_replacement, c, flags=re.DOTALL)

with io.open('src/main/java/com/nurselogic/controller/ExportServlet.java', 'w', encoding='utf-8') as f:
    f.write(c)
print('Replaced ExportServlet blocks successfully')
