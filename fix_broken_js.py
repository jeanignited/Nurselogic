...
m = re.search(r"let diagStr = \(data\.diagnosticoClinico.*?\} else \{\s*document\.getElementById\('fichaReceta'\)\.innerText = recStr;\s*\}", c, re.DOTALL)
if m:
    ...
    with io.open('src/main/webapp/includes/scripts.jsp', 'w', encoding='utf-8') as f:
        f.write(c)
    print("Fixed broken JS")
else:
    print("Not found broken JS")
