...
m = re.search(r'function abrirModalVerDiagnosticoCama\(paciente, btnEl\).*?\}\s*\}\s*(?=// CONEXI)', c, re.DOTALL)
if m:
    old_code = m.group(0)
    new_code = '''function abrirModalVerDiagnosticoCama(paciente, btnEl) {
                ...
                <table class="table table-bordered table-dark-custom mb-0" style="background: rgba(255,255,255,0.02); border-color: rgba(255,255,255,0.1);">
                    <tbody>
                        <tr>
                            ...
                            <td class="fw-semibold text-light"> /  <span class="ms-2 badge bg-secondary">IMC: </span></td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                            ...
                            <td class="fw-bold text-light"></td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                            ...
                            <td class="fw-normal text-light" style="white-space: pre-wrap;"></td>
                        </tr>
                    </tbody>
                </table>
            </div>;
    ...
    document.getElementById('verDiagReceta').innerText = 'No aplica (Hospitalizaci\u00F3n)';
...
'''
    ...
    with io.open('src/main/webapp/includes/scripts.jsp', 'w', encoding='utf-8') as f:
        f.write(c)
    print("Replaced abrirModalVerDiagnosticoCama")
else:
    print("Not found")
