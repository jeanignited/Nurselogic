...
idx1 = c.find('window.procesarCheckout = function() {')
idx2 = c.find('// We need to verify how backend facturarVentaDirecta works!')
if idx1 != -1 and idx2 != -1:
    idx2 = c.find('}', idx2)
    idx2 = c.find('}', idx2+1)
    idx2 = c.find(';', idx2+1)
    old_checkout = c[idx1:idx2+1]
...
'''
    ...
    with io.open('src/main/webapp/includes/scripts.jsp', 'w', encoding='utf-8') as f:
        f.write(c)
    print("Successfully replaced JS checkout logic!")
else:
