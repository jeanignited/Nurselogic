...
m = re.search(r'function abrirModalVerDiagnostico\(paciente, btnEl\).*?(?=function filtrarCitasAvanzado\(\))', c, re.DOTALL)
if m:
    old_code = m.group(0)
    new_code = '''function abrirModalVerDiagnostico(paciente, btnEl) {
