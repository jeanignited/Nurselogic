...
jsp_content = '''<%@ page contentType="application/json;charset=UTF-8" %>
...
<%
    ...
    if (cedula == null || cedula.trim().isEmpty()) {
        out.print("{\\"error\\":\\"C\\u00e9dula no proporcionada\\"}");
        return;
    }
...
with io.open('src/main/webapp/checkCedulaApi.jsp', 'w', encoding='utf-8') as f:
    f.write(jsp_content)
