...
new_vitales = '''    let talla = document.getElementById('atender_estatura_input').value;
    let peso = document.getElementById('atender_peso_input').value;
    let imcValue = document.getElementById('atender_imcValor').innerText;
    let imcState = document.getElementById('atender_imcEstado').innerText;
...
c = c.replace(old_vitales, new_vitales)
