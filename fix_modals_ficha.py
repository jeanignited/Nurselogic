    ...
    <div class="modal-content text-theme" style="background: var(--bg-panel); backdrop-filter: blur(15px); border: var(--glass-border);">
      ...
      <div class="modal-body p-4">
        ...
        <div class="d-flex justify-content-between align-items-center mb-3">
            <h6 class="fw-bold text-primary m-0"><i class="bi bi-heart-pulse-fill text-danger me-2"></i>Evaluación Clínica (ltima)</h6>
...
c = re.sub(r'<!-- Modal Ficha Clinica y Diagnostico Inteligente -->.*?</div>\s*</div>\s*</div>', new_ficha, c, flags=re.DOTALL)
