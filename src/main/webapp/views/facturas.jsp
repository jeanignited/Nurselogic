            ...
            <table class="table table-dark-custom table-hover m-0" id="tablaFacturas">
                <thead style="background: rgba(255,255,255,0.02);">
                    <tr>
                        ...
                        <th>Cliente</th>
                        <th>Detalle</th>
                        <th>Total</th><th class="pe-4 text-center">Acciones</th></tr>
                </thead>
                <tbody>
                    <%
                        ...
                        if(facturas != null && !facturas.isEmpty()) {
                            for(Factura f : facturas) {
                                ...
                                out.print("<td style='font-size: 0.85rem;'><div style='display: -webkit-box; -webkit-line-clamp: 2; -webkit-box-orient: vertical; overflow: hidden; text-overflow: ellipsis; max-height: 2.8em; line-height: 1.4em; min-width: 250px;'>" + detalles.toString() + "</div></td>");
                            ...
                            out.print("<tr><td colspan='6' class='text-center py-5 text-secondary'><i class='bi bi-inbox me-2 fs-4 d-block mb-2'></i>No hay facturas registradas.</td></tr>");
                        }
                    %>
                </tbody>
            </table>
