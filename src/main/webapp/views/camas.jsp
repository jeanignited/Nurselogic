                            ...
                            <% if ("Ocupada".equalsIgnoreCase(estado)) { %>
                                ...
                                <div class="mt-3 small">
                                    ...
                                    <% if (c.get("diagnostico") != null && !c.get("diagnostico").isEmpty()) { %>
                                        <button class="btn btn-sm btn-link text-info p-0 mt-1 d-block text-decoration-none" style="font-size: 0.75rem;"
                                                onclick="abrirModalVerDiagnosticoCama('<%= c.get("paciente").replace("'", "") %>', this)"
                                                data-motivo="<%= c.get("motivo") != null ? c.get("motivo").replace("\"", "&quot;") : "" %>"
                                                data-diagnostico="<%= c.get("diagnostico") != null ? c.get("diagnostico").replace("\"", "&quot;") : "" %>">
                                            <i class="bi bi-journal-text me-1"></i>Ver Diagnóstico
                                        </button>
                                    <% } %>
