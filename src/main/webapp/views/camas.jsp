...
%>        <div id="camas" class="vista-activa d-none">
            ...
            <div class="d-flex justify-content-between align-items-center mb-4 flex-wrap gap-3">
                ...
                <div>
                    ...
                    <h3 class="m-0 fw-bold"><i class="bi bi-hospital me-2" style="color: #22d3ee;"></i>Gesti贸n de Camas y Ocupaci贸n Hospitalaria</h3>

                    <p class="text-secondary m-0 small">Asignaci贸n en tiempo real en Urgencias, Unidad de Cuidados Intensivos (UCI) y Sala General</p>
                ...
                <div class="d-flex gap-2">
                    ...
                    <button class="btn btn-primary text-nowrap rounded-pill px-3 py-2 shadow-sm" onclick="crearNuevaCama()"><i class="bi bi-plus-lg me-1"></i>A帽adir Cama</button>
                        ...
                        <div>
                            ...
                            <% if ("Ocupada".equalsIgnoreCase(estado)) { %>
                                ...
                                <div class="mt-3 small">
                                    ...
                                    <% if (c.get("diagnostico") != null && !c.get("diagnostico").isEmpty()) { %>
                                        <button class="btn btn-sm btn-link text-info p-0 mt-1 d-block text-decoration-none" style="font-size: 0.75rem;" onclick="abrirModalVerDiagnosticoCama('<%= c.get("paciente").replace("'", "") %>', this)" data-diagnostico="<%= c.get("diagnostico").replace("\"", "&quot;") %>"><i class="bi bi-journal-text me-1"></i>Ver Diagn髎tico</button>
                                    <% } %>
                            ...
                            <% } else if ("Mantenimiento".equalsIgnoreCase(estado)) { %>
                                ...
                                <div class="mt-3 small text-warning">
                                    ...
                                    <i class="bi bi-tools me-1"></i>En limpieza o desinfecci贸n protocolaria.
