    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        try {
            if ("pacientes".equalsIgnoreCase(tipo)) {
                ...
                jakarta.persistence.TypedQuery<com.nexusmed.model.Cita> query = em.createQuery(queryStr, com.nexusmed.model.Cita.class);
                if (desdeStr != null && !desdeStr.trim().isEmpty()) {
                ...
                List<com.nexusmed.model.Cita> lista = query.getResultList();
                for (Cita c : lista) {
                ...
                jakarta.persistence.TypedQuery<com.nexusmed.model.Factura> query = em.createQuery(queryStr, com.nexusmed.model.Factura.class);
                if (desdeStr != null && !desdeStr.trim().isEmpty()) {
                ...
                List<com.nexusmed.model.Factura> lista = query.getResultList();
                for (com.nexusmed.model.Factura f : lista) {
                    String detalles = "";
                    for (com.nexusmed.model.FacturaDetalle d : f.getDetalles()) {
