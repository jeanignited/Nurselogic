...
import com.nexusmed.dao.FacturaDAO;
...
public class DashboardServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        try {
            ...
            try {
                List<com.nexusmed.model.Rol> rList = em.createQuery("SELECT r FROM Rol r", com.nexusmed.model.Rol.class).getResultList();
                List<String> listaRoles = new ArrayList<>();
                for(com.nexusmed.model.Rol r : rList) {
            ...
            try {
                ...
                List<com.nexusmed.model.Cita> cList = em.createQuery(citaQuery, com.nexusmed.model.Cita.class).getResultList();
                for(com.nexusmed.model.Cita c : cList) {
                    Map<String, String> map = new HashMap<>();
                    ...
                    com.nexusmed.dao.CitaDAO citaDAO = new com.nexusmed.dao.CitaDAO();
            ...
            try {
                List<com.nexusmed.model.Especialidad> espList = em.createQuery("SELECT e FROM Especialidad e", com.nexusmed.model.Especialidad.class).getResultList();
                ...
                if (espList.isEmpty()) {
                    ...
                    for (String desc : defaultEsps) {
                        com.nexusmed.model.Especialidad newEsp = new com.nexusmed.model.Especialidad();
                ...
                for(com.nexusmed.model.Especialidad esp : espList) {
            ...
            // Lista de Camas
            try {
                List<com.nexusmed.model.Cama> camaList = em.createQuery("SELECT c FROM Cama c ORDER BY c.sala ASC, c.numero ASC", com.nexusmed.model.Cama.class).getResultList();
                for(com.nexusmed.model.Cama cam : camaList) {
