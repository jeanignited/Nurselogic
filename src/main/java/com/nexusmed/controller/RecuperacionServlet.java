...
public class RecuperacionServlet extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        if ("enviarCodigo".equals(action)) {
            ...
            com.nexusmed.service.UsuarioService.RecuperacionResult result = usuarioService.procesarEnvioCodigo(correo, correoEnviado, codigo);
            ...
            com.nexusmed.service.UsuarioService.RecuperacionResult result = usuarioService.procesarResetClave(correo, codigoIngresado, nuevaClave);
    ...
    private boolean enviarCorreo(String destinatario, String codigo) {
        ...
        String username = System.getenv("NEXUSMED_EMAIL_USER") != null ? System.getenv("NEXUSMED_EMAIL_USER") : "tucorreo@gmail.com"; 
        String password = System.getenv("NEXUSMED_EMAIL_PASS") != null ? System.getenv("NEXUSMED_EMAIL_PASS") : "lzfv yvnb notu nreq";
        ...
        try {
            ...
            message.setSubject("Código de Recuperación de Cuenta - NEXUSMED");
            
            String cuerpoCorreo = "Hola,\n\n"
                    + "Hemos recibido una solicitud para restablecer la contraseña de tu cuenta en el Sistema Clínico Integrado NEXUSMED.\n\n"
                    ...
                    + "Atentamente,\n"
                    + "El Equipo de Soporte de NEXUSMED";
