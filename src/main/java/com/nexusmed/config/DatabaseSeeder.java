...
public class DatabaseSeeder implements ServletContextListener {
    ...
    public void contextInitialized(ServletContextEvent sce) {
        ...
        try {
            ...
            if (rolCount == 0) {
                em.persist(new com.nexusmed.model.Rol("Admin", "Administrador del sistema", "GESTION_USUARIOS,GESTION_MEDICAMENTOS,GESTION_CATALOGOS,REGISTRO_PACIENTES,AGENDAR_CITAS"));
                em.persist(new com.nexusmed.model.Rol("Medico", "Personal médico", "REGISTRO_PACIENTES,AGENDAR_CITAS"));
                em.persist(new com.nexusmed.model.Rol("Paciente", "Paciente del sistema", "AGENDAR_CITAS"));
                em.persist(new com.nexusmed.model.Rol("Pendiente", "Usuario pendiente de aprobación", ""));
                em.persist(new com.nexusmed.model.Rol("Farmaceuta", "Personal de farmacia", "GESTION_MEDICAMENTOS,GESTION_CATALOGOS"));
            }
            ...
            if (espCount == 0) {
                com.nexusmed.model.Especialidad e1 = new com.nexusmed.model.Especialidad(); e1.setDescripcion("Medicina General"); em.persist(e1);
                com.nexusmed.model.Especialidad e2 = new com.nexusmed.model.Especialidad(); e2.setDescripcion("Cardiología"); em.persist(e2);
                com.nexusmed.model.Especialidad e3 = new com.nexusmed.model.Especialidad(); e3.setDescripcion("Pediatría"); em.persist(e3);
                com.nexusmed.model.Especialidad e4 = new com.nexusmed.model.Especialidad(); e4.setDescripcion("Urgencias y Triage"); em.persist(e4);
                com.nexusmed.model.Especialidad e5 = new com.nexusmed.model.Especialidad(); e5.setDescripcion("Neurología"); em.persist(e5);
            }
