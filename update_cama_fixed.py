...
m = re.search(r'function abrirModalVerDiagnosticoCama\(paciente, btnEl\).*?m\.show\(\);\s*\}\s*\}', c, re.DOTALL)
if m:
    old_code = m.group(0)
    new_code = r'''function abrirModalVerDiagnosticoCama(paciente, btnEl) {
